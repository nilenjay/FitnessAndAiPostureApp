  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: uid == null
        ...
        // ✅ FutureBuilder instead of StreamBuilder to avoid deadlock
        // ✅ NO orderBy — sorts in memory to avoid index requirement
            ...
            return Center(
              child: Column(
                ...
                children: [
                  ...
                  const Text('Complete a session to see it here.',
