      ...
      builder: (dialogContext) => AlertDialog(
        ...
        actions: [
          ...
          TextButton(
            ...
            child: const Text('Sign Out', style: TextStyle(color: AppTheme.error, fontWeight: FontWeight.w700)),
          ),
        ],
      ),
    );
            ...
            child: Column(
              children: [
                ...
                GridView.count(
                  ...
                  children: [
                    _StatCard('Total Reps', '$totalReps',
                        Icons.fitness_center, AppTheme.primary),
                    _StatCard('Sessions', '$totalSessions',
                        Icons.calendar_today, AppTheme.secondary),
                    _StatCard('Streak', '$streak Days',
                        Icons.local_fire_department, Colors.orange),
                    _StatCard('Level',
                        totalSessions < 10 ? 'Beginner' : totalSessions < 30 ? 'Intermediate' : 'Advanced',
                        Icons.psychology, Colors.purpleAccent),
                  ],
                ),
